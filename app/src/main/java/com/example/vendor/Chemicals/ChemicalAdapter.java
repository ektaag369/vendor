...
import com.example.vendor.Seeds.SeedDetailActivity;
...
public class ChemicalAdapter extends RecyclerView.Adapter<ChemicalAdapter.ChemicalViewHolder>{
    Context context;
    ArrayList<ChemicalModelClass> chemicallist;
    Constants constants=new Constants();
    Intent intent;

    public ChemicalAdapter(Context context, ArrayList<ChemicalModelClass> chemicallist) {
    ...
    public ChemicalViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.chemical_item,parent,false);
    ...
    public void onBindViewHolder(@NonNull ChemicalViewHolder holder, int position) {
        ...
        holder.linearLayout.setOnClickListener(v-> {
            ...
            intent = new Intent(context, ChemicalDetailActivity.class);
